...
@RestController @RequestMapping("/api/games") public class GameController {
 ...
 public record View(String code,Game.Status status,Game.Phase phase,List<PlayerDto> players,UUID currentPlayerId,UUID responderId,UUID winnerId,List<CardDto> hand,List<CardDto> cards,List<CardDto> suggestedCards,List<CardDto> solution,List<EventDto> events){}
